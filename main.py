...
from api.routes.withllm_extraction import router as withllm_extraction_router
...
app.include_router(withllm_extraction_router, prefix="/api/v1/withllm", tags=["Extraction (LLM)"])
